...
export default function ContactForm() {
  ...
  return (
    <div ref={containerRef} className="bg-[var(--bg)] min-h-screen text-[var(--text)] transition-colors duration-300">
      <section className="pt-32 pb-16 md:pt-40 md:pb-24 px-6 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-start">
          ...
          <div className="lg:col-span-5 contact-animate">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 lg:gap-12 pt-8 border-t border-[var(--border-sub)]/30">
              <div>
                ...
                <a href="mailto:hello@digitalheroesco.com" className="text-lg font-medium hover:underline cursor-pointer transition-all">
          ...
          <div className="lg:col-span-7 contact-animate">
            <div className="bg-[var(--text)]/5 p-8 md:p-12 rounded-3xl border border-[var(--border-sub)]/25 shadow-sm">
              <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-8">
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <input
                    ...
                    aria-required="true"
                    className="bg-transparent border-b border-[var(--border-sub)]/50 py-2 focus:border-[var(--text)] outline-none focus-visible:ring-1 focus-visible:ring-[var(--text)] transition-all text-base placeholder:opacity-30"
                  />
                </div>
                ...
                <div className="flex flex-col gap-3 md:col-span-2">
                  ...
                  <textarea
                    ...
                    aria-required="true"
                    className="bg-transparent border-b border-[var(--border-sub)]/50 py-2 focus:border-[var(--text)] outline-none focus-visible:ring-1 focus-visible:ring-[var(--text)] transition-all text-base resize-none placeholder:opacity-30"
                  />
                </div>
                ...
                <div className="md:col-span-2 pt-4">
                  <button
                    ...
                    type="submit"
                    className="w-full md:w-auto bg-[var(--text)] text-[var(--bg)] px-12 py-5 rounded-full uppercase text-[10px] font-bold tracking-widest hover:scale-[1.02] active:scale-95 transition-all disabled:opacity-50 shadow-lg focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[var(--text)] outline-none"
                  >
